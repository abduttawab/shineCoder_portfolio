...
export class UserProfileComponent implements OnInit {
    ...
    editDob() {
        const $birthdate =($('#birthdate') as any);// $('#birthdate');
    ...
    editGender() {
        const $addGenderDropdown = ($('#gender') as any);// $('#gender');
    ...
    editAddress() {
        ...
        const $billingCountry =($('#country') as any);// $('#country');
        const $billingState = $('#state');
        const $shippingCountry = ($('#scountry') as any);//$('#scountry');
